...
forecast_by_issue_time <- function(issue, ensemble, telemetry,
  ...
  ts <- switch(metadata$forecast_type,
               "bma_sliding"=get_bma_ts(first_valid, t_idx_series, ens_test, ensemble, telemetry,
                                    sun_up, site, AC_rating, metadata,
                                    lm_formula),
               "emos_sliding"=get_emos_ts(first_valid, t_idx_series, ens_test, ensemble, telemetry,
                                          sun_up, site, AC_rating, metadata),
               "bma_constant"=get_bma_ts(first_valid, t_idx_series, ens_test, ensemble, telemetry,
                                          sun_up, site, AC_rating, metadata,
                                          lm_formula),
               ...
               "bma_time-of-day"=get_bma_ts(first_valid, t_idx_series, ens_test, ensemble, telemetry,
                                        sun_up, site, AC_rating, metadata,
                                        lm_formula),
               "emos_time-of-day"=get_emos_ts(first_valid, t_idx_series, ens_test, ensemble,
